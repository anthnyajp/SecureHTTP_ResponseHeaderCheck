...
with open(input_file_path, "r", buffering=-1) as input_file, open(
    ...
    for url in input_file:
        ...
        try:
            ...
            referrer = urlparse(url).scheme + "://" + urlparse(url).netloc
            ...
            x_permitted_cross_domain_policies = response.headers.get(
            ...
            cross_origin_resource_policy = response.headers.get(
            ...
            Fullhostname1 = (
                parsed_uriInitial.scheme + "://" + parsed_uriInitial.hostname
            )
            ...
            if final_url.startswith("http"):
                ...
                if 'a href="http://' in response.text:
                    http_links = True
...
print(Exception_Count, " Exceptions")
